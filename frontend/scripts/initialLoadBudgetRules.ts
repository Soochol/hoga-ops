...
export const INITIAL_LOAD_BUDGET = {
  ...
  //
  // raw 1,300 → 1,308 KB (2026-08-22): 캘린더 봉 창 → 분봉 창 **기간 점프**
  // (「분봉으로」 버튼 · `g` 단축키 · 점프 칩 · 순수 판정층 · 스토어 채널 ·
  // 소비 훅 · 백필 3d 일반화). 실측 내 몫 **raw +7.2 KB / gzip +2.1 KB**
  // (base e4fbea5b 단독 1,299.3 / 391.3 → 1,306.5 / 393.4).
  //
  ...
  //
  // 새 헤드룸 1.5 KB — 위 항목들(0.6~1.9)과 같은 자릿수다.
  // gzip 은 393.4/400 으로 안쪽이라 올리지 않는다(그리고 게이트도 아니다 — 아래 절).
  rawBytes: 1_308 * 1024,
  /**
