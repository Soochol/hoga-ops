 ...
 * 있다**(ADR-0155) — 뱃지·팔레트 배선이 저쪽과 같은 모양이고, 다른 것은 번호가
 ...
 *
 * **거의 전부가 `windowId` 를 받는 함수다**(ADR-0155). 값으로 실으면 "모든 창이 같은
...
export interface StudyItemCtx {
   ...
   *
   *  창마다 봉·번들·저장뷰가 다르므로 값이 아니라 **함수**다(#801 · ADR-0155). */
...
export function StudyWorkspaceCanvas({
  ...
  /** 아래 다섯은 전부 **창 id → 값**이다(ADR-0155) — 창마다 그룹이, 그룹마다 저장뷰가
