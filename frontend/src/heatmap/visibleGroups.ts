import type { EntryWithFolderOrder, FolderGroup } from '../watchlist/grouping';
...
export function visibleFolderGroups<TEntry extends EntryWithFolderOrder>(
  groups: FolderGroup<TEntry>[],
): FolderGroup<TEntry>[] {
