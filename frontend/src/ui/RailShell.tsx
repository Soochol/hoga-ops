...
export function RailTreeRow({
  ...
  return (
    <div
      {...props}
      className={`flex cursor-pointer items-center gap-2 pl-10 pr-md py-sm hover:bg-bg-input-hover focus:outline-none focus:ring-1 focus:ring-inset focus:ring-line ${className}`.trim()}
    >
      {children}
    </div>
  );
