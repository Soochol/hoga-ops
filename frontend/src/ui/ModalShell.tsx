...
export function ModalShell({ ariaLabel, title, width = 'w-[640px]', onClose, children }: {
  ariaLabel: string;
  title?: string;
  width?: string;
  onClose: () => void;
  ...
  return (
    <div role="dialog" aria-modal="true" aria-label={ariaLabel} onClick={onClose}
      ...
      <div onClick={(e) => e.stopPropagation()}
        className={`bg-bg-card border border-border-strong rounded-[6px] shadow-[0_8px_24px_rgba(0,0,0,0.4)] ${width} max-w-[90vw] flex flex-col`}>
        {title && (
