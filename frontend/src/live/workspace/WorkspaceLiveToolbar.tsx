  ...
  return (
    <WorkspaceToolbar testId="workspace-live-toolbar" className="flex-nowrap">
      ...
      <IconToolbarButton
        ...
        icon={<span aria-hidden className="inline-flex h-[14px] w-[14px] items-center justify-center rounded border border-border-strong font-data text-badge leading-none">?</span>}
      >
        단축키
      </IconToolbarButton>
