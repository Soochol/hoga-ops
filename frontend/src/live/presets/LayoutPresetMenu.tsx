 ...
 *
 * 프리셋 = **창·배치 스냅샷**. 적용 시 창은 교체되지만 보고 있는 종목은 유지된다 —
 * 문구·안내가 이를 알린다(v3 의 종목 교체는 철회, `WorkspaceSnapshot` 주석 참조).
 *
  ...
  return (
    <PresetMenu<LiveLayoutPresetPayload>
      ...
      labels={{
        buttonFallback: '레이아웃',
        ariaLabel: '레이아웃 프리셋',
        applyHint: '적용 시 창 배치만 교체됩니다 — 보고 있는 종목은 유지',
        applyTitle: '이 배치로 교체 — 창만 대체되고 종목은 그대로입니다',
