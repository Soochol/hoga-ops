...
export type RailPanel = 'watchlist' | 'screener' | 'savedViews' | 'signalAlerts' | 'heatmap' | 'ranking';
const VALID_PANELS: readonly RailPanel[] = ['watchlist', 'screener', 'savedViews', 'signalAlerts', 'heatmap', 'ranking'];
