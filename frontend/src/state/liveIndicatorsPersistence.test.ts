...
describe('mergeLiveIndicatorPrefs', () => {
  it('returns defaults for undefined input', () => {
    expect(mergeLiveIndicatorPrefs(undefined)).toEqual({
      ...
      quoteTotalsDayMaxLineEnabled: false,
      quoteTotalsDayMaxBidColor: '#F04452',
      quoteTotalsDayMaxBidWidth: 1,
      quoteTotalsDayMaxBidStyle: 'dotted',
      quoteTotalsDayMaxAskColor: '#3485FA',
      quoteTotalsDayMaxAskWidth: 1,
      quoteTotalsDayMaxAskStyle: 'dotted',
      ratioEnabled: true,
