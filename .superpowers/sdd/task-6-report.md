...
- Frontend typecheck/build is still blocked by Task 7 scope boundaries. The remaining failures are limited to the live/study fallback hooks and their tests, which still expect the old store-owned bypass field.
