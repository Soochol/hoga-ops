...
NON_PRICE_FIELDS: frozenset[str] = frozenset({
    ...
    "AskPeak.untraded_qty", "AskPeak.untraded_t_ms",
    "AskPeak.untraded_max_qty", "AskPeak.untraded_max_t_ms",
    "AskPeak.traded_peaks", "AskPeak.traded_max_peaks",
    "AskPeak.untraded_peaks", "AskPeak.untraded_max_peaks",
    ...
    "BidPeak.untraded_qty", "BidPeak.untraded_t_ms",
    "BidPeak.untraded_max_qty", "BidPeak.untraded_max_t_ms",
    "BidPeak.traded_peaks", "BidPeak.traded_max_peaks",
    "BidPeak.untraded_peaks", "BidPeak.untraded_max_peaks",
