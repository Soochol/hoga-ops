...
>
> **실측 결과** — 81 파일 · **−10,202 / +327 라인**. 추정(≈9,359)과의 차이는 §9 가
> 설명한다. 초기 로드는 **−8.1 KB** 로, CLAUDE.md 가 인용하는 「study-views 72KB」와
...
### 9-4. 남긴 것 — **한 페이지짜리 일반화** 정리는 별도 작업
...
- **CONTEXT.md:387** — `/study` 가 캘린더 봉에서 호가 지표를 집계한다는 서술은 §2.1 이
  보인 대로 **삭제 전부터 stale** 이었다. `/study` 항목 정리와 함께 고칠 것.
- **ADR-0077 의 v1 절** — v1 스냅샷 학습뷰는 스키마가 `Literal[2]` 하나가 되면서 이미
  사라졌다.
- **신규 ADR** — 0077·0123·0144·0149·0155 부분 supersede. 0149/0155 의 「무효/유지」 형식.
