...
class DerivFlowStore:
    ...
    def __init__(self, data_dir: Path) -> None:
        ...
        # 종일 자라는 append 로그라(실측 2026-08-21: deriv 8.1MB·4,239표본) 파싱
        # 비용이 장중 내내 선형으로 커지고, 수집기가
        ...
        self._last_cache: dict[tuple[str, str], DerivSample] = {}
    ...
    def append_sample(self, date: str, sample: DerivSample) -> None:
        ...
        self._last_cache[(date, sample.product)] = sample
