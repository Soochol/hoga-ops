...
#
# 연속 스냅샷 diff 계열(2026-08-25 에 제거된 단별 잔량 증감이 그랬다)은 두 스냅샷의
# 공통 가격만 INNER JOIN 해 관측창 이동 아티팩트를 통째로 배제한다.
# wall_surge 는 **규칙이 정반대다** — 바로 그 배제 대상을 **셋으로 가른다**: 반대측 자리였다가 넘어온 것은
