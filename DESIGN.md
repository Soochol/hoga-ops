...
- **구분선 최소화 — "톤 밴드" (2026-07-22, /live 프로토타입 4시안 비교로 C안 채택):** 크롬
  ...
  `border` 대신 `--bg-subtle` 밴드 — **단 거래원 "외국계 합계" 행은 예외로 창 본문과 같은
  `--bg-card`**(2026-07-30 사용자 결정, 아래 결정로그), lightweight-charts 시간/가격 축 `borderVisible: false`
